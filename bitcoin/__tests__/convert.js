...
test('should default to returning then default ifself', () => {
  expect(convert(2, 'BTC', 'BTC');).toBe('default');
});
...
test('should throw when untest is undefined', () => {
  expect(convert(new Big(2), 'x', 'BTC', 'Number');).toThrowError("undefined");
  expect(convert(new Big(2), 'BTC', 'x', 'Number');).toThrowError("undefined");
  expect(convert(NaN, 'x', 'BTC', 'Number');).toThrowError("undefined");
  expect(convert(NaN, 'BTC', 'x', 'Number');).toThrowError("undefined");
});

test('should throw when representaion is undefined', () => {
  expect(convert(2, 'BTC', 'mBTC', 'x');).toThrowError("undefined");
  expect(convert(NaN, 'BTC', 'mBTC', 'x');).toThrowError("undefined");
});
